...
- 🦊 Husky for Git Hooks
- 🤖 Dependabot for automatic version bump
...
```
git clone --depth=1 https://github.com/alex-streza/nextjs-tailwind-template my-project-name
cd my-project-name
npm install
```
...
- `src/shared/main.css`: your CSS file using Tailwind CSS
- `src/layouts/Main.tsx`: default theme
